...
4. 합병 정렬과 마찬가지로 퀵 정렬 함수가 다시 부분 리스트에 대하여 순환 호출되며, 부분 리스트에서 다시 피봇을 정하고 피봇을 기준으로 2개의 부분 리스트로 나누는 고정 되풀이
...
<div align="center">
<img src="hhttps://github.com/user-attachments/assets/8092d107-e5c8-4b37-ae70-d03f4769c1a5">
</div>
...
<img src="https://github.com/user-attachments/assets/306b4125-0295-461c-b697-570ec1e708d6">
  ...
  - 즉, low와 high를 왼쪽과 오른쪽에서 출발시켜서 부적절한 데이터를 만나게 되면 교환, 아니라면 계속 진행하다가 서로 엇갈리게 되면 멈춰서 피봇을 중앙으로 이동시켜 피봇을 기준으로 2개의 리스트로 나누어짐
